...
[Open in Github](https://github.com/openai/openai-cookbook/blob/main/examples/deep_research_api/introduction_to_deep_research_api_agents.ipynb) [View as Markdown](https://nbviewer.org/format/script/github/openai/openai-cookbook/blob/main/examples/deep_research_api/introduction_to_deep_research_api_agents.ipynb)
...
### [Prerequisites](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api_agents\#prerequisites)

- OpenAI API key (set as OPENAI\_API\_KEY in your environment)
- Agents SDK and OpenAI Python SDK

### [Setup](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api_agents\#setup)
...
### [Import libraries and configure client](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api_agents\#import-libraries-and-configure-client)
...
### [Basic Deep Research Agent](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api_agents\#basic-deep-research-agent)
...
### [Multi-Agent Research with Clarification](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api_agents\#multi-agent-research-with-clarification)
...
## [Sub-Agent Prompt enrichment](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api_agents\#sub-agent-prompt-enrichment)
...
# [Four-Agent Deep Research Pipeline](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api_agents\#four-agent-deep-research-pipeline)
...
![../../images/agents_dr.png](https://cookbook.openai.com/images/agent_dr.png)
...
## [Agent Interaction Flow](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api_agents\#agent-interaction-flow)
...
## [Citations](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api_agents\#citations)
...
### [Conclusion](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api_agents\#conclusion)
