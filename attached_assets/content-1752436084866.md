...
[Open in Github](https://github.com/openai/openai-cookbook/blob/main/examples/deep_research_api/introduction_to_deep_research_api.ipynb) [View as Markdown](https://nbviewer.org/format/script/github/openai/openai-cookbook/blob/main/examples/deep_research_api/introduction_to_deep_research_api.ipynb)

## [Background](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api\#background)
...
## [Setup](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api\#setup)

### [Install requirements](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api\#install-requirements)
...
### [Authenticate](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api\#authenticate)
...
## [Getting started](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api\#getting-started)
...
## [Parse the Response](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api\#parse-the-response)
...
### [Extract the Final Report Output](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api\#extract-the-final-report-output)
...
### [Access Inline Citations and Metadata](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api\#access-inline-citations-and-metadata)
...
### [Inspect Intermediate Steps](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api\#inspect-intermediate-steps)
...
#### [Reasoning Step](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api\#reasoning-step)
...
#### [Web Search Call](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api\#web-search-call)
...
#### [Code Execution](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api\#code-execution)
...
#### [Model Context Protocol (MCP)](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api\#model-context-protocol-mcp)
...
## [Reviewing your response](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api\#reviewing-your-response)
...
## [Clarifying Questions in ChatGPT vs. the Deep Research API](https://cookbook.openai.com/examples/deep_research_api/introduction_to_deep_research_api\#clarifying-questions-in-chatgpt-vs-the-deep-research-api)
...
![../../images/intro_dr.png](https://cookbook.openai.com/images/intro_dr.png)
